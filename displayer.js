...
async function exportToExcel() {
	...
	try {
		...
		// Update styles.xml fill 23 to RGB FFA6A6A6 (RGB=166,166,166)
		...
		// Apply merge styles (s=178, 179, 180 with RGB 166,166,166 fill) and construct merge refs for unused rounds
