...
const TIEBREAK_CRITERIA = {
	...
	'μεταξύ_τους_κατά': 'Λιγότερα κατά στους μεταξύ τους αγώνες',
	'συνολική_διαφορά': 'Συνολική διαφορά',
	'συνολικά_υπέρ': 'Συνολικά υπέρ',
	'συνολικές_νίκες': 'Συνολικές νίκες',
	'συνολικά_κατά': 'Λιγότερα συνολικά κατά',
	'id': 'Μικρότερο ID ομάδας',
	'τυχαία': 'Τυχαία ομάδα',
	'επιλογή_χρήστη': 'Επιλογή χρήστη',
};
